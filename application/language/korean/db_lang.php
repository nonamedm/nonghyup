...
$lang['db_transaction_failure'] = '트랜잭션 실패 : 롤백이 실행 되었습니다.';
$lang['db_unable_to_drop'] = '명시된 데이터베이스를 드롭할 수 없습니다.';
$lang['db_unsuported_feature'] = '시스템이 사용하고 있는 데이터베이스에서는 지원되지 않는 기능입니다.';
...
$lang['db_must_use_index'] = '일괄 업데이트를 사용하려면 이용할 수 있는 데이터가 있는 목록 파일이 필요합니다.';
$lang['db_batch_missing_index'] = '일괄 업데이트를 사용하기 위해 지정한 목록 파일이 없습니다.';
