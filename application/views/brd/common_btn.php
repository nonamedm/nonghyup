...
*/
if($bbs_mod == 'lists'){ ?>
    <?php if( $write_perm['cd']=='pass' && $svc_mod=='adm' ){ ?>
...
*/
    ...
    <?php if ($reply_perm['cd'] == 'pass' && $svc_mod=='adm') {?>
    ...
    <?php if ( ($g_id!='query' && $modify_perm['cd'] == 'pass' && $svc_mod=='adm') || ($view['ord']>0 && $modify_perm['cd'] == 'pass' && $svc_mod=='adm') ) {?>
