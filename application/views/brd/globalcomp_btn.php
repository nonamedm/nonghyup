...
*/
if($bbs_mod == 'lists'){ ?>
    <?php if( $usr_arr['usr_id']=='2910703673'||$usr_arr['usr_id']=='2259084387'||$usr_arr['usr_id']=='3282972707'||$usr_arr['usr_id']=='admin'||$usr_arr['usr_id']=='hwonpark'||$usr_arr['usr_id']=='ycneh'||$usr_arr['usr_id']=='nhbank8739'){ ?>
...
*/
    ...
    <?php if ( ($view['ord']>0 && $modify_perm['cd'] == 'pass' && $svc_mod=='adm') || ($usr_arr['usr_id']=='2910703673'||$usr_arr['usr_id']=='2259084387'||$usr_arr['usr_id']=='3282972707'||$usr_arr['usr_id']=='admin'||$usr_arr['usr_id']=='hwonpark'||$usr_arr['usr_id']=='ycneh'||$usr_arr['usr_id']=='nhbank8739') ) {?>
