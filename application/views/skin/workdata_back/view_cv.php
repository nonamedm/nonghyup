    ...
    <div class="brd_view">
        ...
        <div class="cont_box">
            ...
            <div class="data uk-placeholder">
                <div class="unit"><span class="tit">법령명 : </span><span class="txt"><?php echo $view['post_opt'];?></span></div>
                <div class="unit"><span class="tit">발행기관 : </span><span class="txt"><?php echo $view['post_field'];?></span></div>
                <div class="unit"><span class="tit">회신일 : </span><span class="txt"><?php echo $view['post_dtms'];?></span></div>
            </div>
