                ...
                <?php for($i=0; $i<count($lists); $i++, $li_idx--){ ?>
                    <tr>
                        ...
                        <td class="tit" id="tit<?php echo $i;?>">
                            <?php if ($lists[$i]['ord']) { ?>
                            <span class="uk-margin-small-left"><img src="/static/svg/ico_reply.svg"></span>
                            <?php }?>

                            <?php if($is_adm_mod){ ?>
                            <a href="/<?php echo $seg;?>/<?php echo $m_id;?>/view?idx=<?php echo $lists[$i]['idx'];?>" class="chk_perm_view <?php if($lists[$i]['ord']==0){echo 'ori';}?>">
                            <?php }else{ ?>
                            <a href="/<?php echo $seg;?>/<?php echo $m_id;?>/view?idx=<?php echo $lists[$i]['trgt_idx'];?>" class="chk_perm_view <?php if($lists[$i]['ord']==0){echo 'ori';}?>">
                            <?php } ?>
                        ...
                        <td class="w180">
                            <?php echo $lists[$i]['usr_nm'];?><?php if($is_adm_mod){?> ( <?php echo $lists[$i]['usr_id'];?> )<?php }?>
                        </td>
