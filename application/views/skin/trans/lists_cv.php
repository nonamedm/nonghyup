            ...
            <?php for($i=0; $i<count($lists); $i++, $li_idx--){ ?>
                <tr class="mtr">
                    <td class="">
                        ...
                        <div class="caption">
                            <span class="cat"><?php echo $lists[$i]['post_opt'];?></span>
                            <span class="cat"><?php echo $lists[$i]['post_field'];?></span>
                            <span class="cat"><?php echo substr($lists[$i]['post_dtms'], 2, 8);?></span>
                        </div>
                    </td>
                </tr>
                <tr class="wtr">
                    ...
                    <td class="reg_date"><?php echo substr($lists[$i]['post_dtms'], 2, 8);?></td>
                    <?php if($is_adm_mod){ ?>
