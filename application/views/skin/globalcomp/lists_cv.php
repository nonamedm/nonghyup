        ...
        <table class="uk-table uk-table-small uk-table-divider">
            ...
            <tbody>
                <?php for ($i = 0; $i < count($lists); $i++, $li_idx--) { ?>
                    ...
                    <tr class="wtr <?php if ($lists[$i]['post_fix'] == 'Y') echo "fix"; ?>" <?php if ($lists[$i]['post_fix'] == 'Y') echo "style=background-color:#f4f4f4"; ?>>
                        <td class="no"><?php if ($lists[$i]['post_fix'] == 'Y') echo '-';
                                        else echo $li_idx; ?></td>
                        <?php if ($m_id == 'globalcomp2') { ?>
                            <td class="cat">
                                <div class="w100 ellipsis"><?php echo $lists[$i]['post_opt']; ?></div>
                            </td>
                        <?php } else { ?>
                        <?php } ?>
...
// ***** bbs nav
if (($m_id == 'globalcomp1' || $m_id == 'globalcomp2' || $m_id == 'globalcomp3' || $m_id == 'globalcomp4') && ($usr_arr['usr_id'] == 'swiri3101' || $usr_arr['usr_id'] == 'suqhfka' || $usr_arr['usr_id'] == 'patty0327' || $usr_arr['usr_id'] == 'admin')) {
