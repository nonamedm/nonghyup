...
<div class="section nav">
    <nav class="uk-navbar-container uk-navbar-transparent" uk-navbar>
        ...
        <div class="uk-navbar-center mm menubar uk-visible@l">
            <ul class="gnb">
                <?php if ($usr_arr['usr_id'] == 'nacf5061' || $usr_arr['usr_id'] == 'nacf50611' || $usr_arr['usr_id'] == 'wtadmin' || $usr_arr['usr_id'] == '17311795' || $usr_arr['usr_id'] == '19312949' || $usr_arr['usr_id'] == '08305788' || $usr_arr['usr_id'] == '21613193' || $usr_arr['usr_id'] == 'swiri3101' || $usr_arr['usr_id'] == 'suqhfka' || $usr_arr['usr_id'] == 'patty0327') { ?>
                    <li class="menu">
                ...
                <?php } else { ?>
                    <?php for ($i = 0; $i < count($nav_tree[0]['sub']); $i++) {
                        if ($nav_tree[0]['sub'][$i]['visible_yn'] != "N") { ?>
                            <li class="menu">
                                <a href="/<?php echo $seg; ?>/<?php echo $nav_tree[0]['sub'][$i]['id']; ?>" class="<?php if ($nav_tree[0]['sub'][$i]['id'] == $g_id) {
                                                                                                                        echo 'focus';
                                                                                                                    } ?>">
        ...
        <div class="uk-hidden@l" id="m_menu">
            <button id="mtoggle" class="uk-navbar-toggle uk-navbar-toggle-icon uk-icon uk-hidden@l" uk-scroll><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" ratio="1">
