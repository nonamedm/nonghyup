 ...
 */
    ...
    public function chk_ip(){
        $rtn = false;
        if($_SERVER["REMOTE_ADDR"]=='1.255.77.102' ||$_SERVER["REMOTE_ADDR"]=='223.26.222.72' ||$_SERVER["REMOTE_ADDR"]=='121.170.124.236' ||$_SERVER["REMOTE_ADDR"]=='183.111.174.96'|| $_SERVER["REMOTE_ADDR"]=='192.168.219.104'||$_SERVER["REMOTE_ADDR"]=='210.91.190.155' || $_SERVER["REMOTE_ADDR"]=='223.38.81.134' || $_SERVER["REMOTE_ADDR"]=='221.162.119.225'|| $_SERVER["REMOTE_ADDR"]=='121.170.124.236' || $_SERVER["REMOTE_ADDR"]=='1.231.30.68'|| $_SERVER["REMOTE_ADDR"]=='1.230.201.166'||$_SERVER["REMOTE_ADDR"]=='1.230.201.157' || $_SERVER["REMOTE_ADDR"]=='1.230.201.152' || $_SERVER["REMOTE_ADDR"]=='1.230.201.96'|| $_SERVER["REMOTE_ADDR"]=='1.230.201.102'|| $_SERVER["REMOTE_ADDR"]=='211.36.158.248' || $_SERVER["REMOTE_ADDR"]=='1.230.201.128' || $_SERVER["REMOTE_ADDR"]=='1.230.201.140'){
            $rtn = true;
        }else{
