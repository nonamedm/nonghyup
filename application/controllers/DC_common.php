 ...
 */
    ...
    public function chk_ip()
    {
        ...
        if (
            ...
            || $_SERVER["REMOTE_ADDR"] == '10.1.203.200' || $_SERVER["REMOTE_ADDR"] == '10.1.209.155' || $_SERVER["REMOTE_ADDR"] == '10.1.209.213' || $_SERVER["REMOTE_ADDR"] == '211.36.148.130' || $_SERVER["REMOTE_ADDR"] == '25.1.209.109'
        ) {
            $rtn = true;
        } else {
